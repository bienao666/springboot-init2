package life.bienao.springbootinit.aspectj;
...
import life.bienao.springbootinit.enums.BusinessStatus;
import life.bienao.springbootinit.filter.PropertyPreExcludeFilter;
import life.bienao.springbootinit.mapper.SysOperLogMapper;
import life.bienao.springbootinit.util.*;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            // 保存数据库
            sysOperLogMapper.insertSysOperLog(operLog);
        }
        catch (Exception exp)
        {
            // 记录本地异常日志
